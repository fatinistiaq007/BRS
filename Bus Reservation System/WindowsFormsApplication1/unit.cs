...
namespace WindowsFormsApplication1
{
    ...
    public class unit
    {
        ...
        {
            bool r = ob.entrybusdata(2001, "Tisha", "Dhaka", "Comilla", "21/08/18", "4:00pm", "07:00pm", 40, 300);
            Assert.IsTrue(r);
        }
        [Test]
        public void deletesucc()
        {
            bool r = ob.deletebusdata(2001);
            Assert.IsTrue(r);
        }
        [Test]
        public void updatesucc()
        {
            bool r = ob.updatebusdata(2001, "Tisha", "Dhaka", "Comilla", "21/08/18", "4:00pm", "07:00pm", 40, 300);
            Assert.IsTrue(r);
        }
        [Test]
